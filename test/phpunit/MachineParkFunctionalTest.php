...
/**
 * \file    test/phpunit/MachineParkFunctionalTest.php
 * \ingroup machinepark
...
/**
 * Class MachineParkFunctionalTest
 *
 ...
 *
 * @package Testmachinepark
 */
class MachineParkFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMachinePark')->click();
		} else {
			// Disable the module
			$this->byHref('modMachinePark')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/machinepark/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('machinepark/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/machinepark/admin/about.php');
		$this->authenticate();
		return $this->assertContains('machinepark/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('machineparkwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMachinePark_MachineParkTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMachinePark_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
